...
while (1)
    ...
    break;
    case 2:  PORTA.6=0; PORTA.5=1;PORTA.4=0;PORTA.3=0;comand=0; delay_ms(200);
    break;
    case 3:  PORTA.6=0; PORTA.5=0;PORTA.4=1;PORTA.3=0;comand=0; delay_ms(200);
    break;
    case 4:  PORTA.6=0; PORTA.5=0;PORTA.4=0;PORTA.3=1;comand=0; delay_ms(400);
    break; 
